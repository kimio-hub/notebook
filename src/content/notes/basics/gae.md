...
tags:
  - rl
  - policy-optimization
description: "GAE（Generalized Advantage Estimation）是一种用于估计优势函数的方法，核心目标是平衡偏差（bias）和方差（variance）。它常与 [PPO](/notes/basics/ppo/) 搭配使用，用来给策略更新提供更稳定的 advantage 信号。"
category: "basics"
date: "2026-07-09"
updated: "2026-07-09"
---
...
## 摘要
GAE（Generalized Advantage Estimation）是一种用于估计优势函数的方法，核心目标是平衡偏差（bias）和方差（variance）。它常与 [PPO](/notes/basics/ppo/) 搭配使用，用来给策略更新提供更稳定的 advantage 信号。
...
- 在 [PPO](/notes/basics/ppo/) 中，GAE 常被用来构造 $\hat A_t$，让策略更新既稳定又有效。
